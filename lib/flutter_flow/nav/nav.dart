      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => LoginPageWidget(
            isas: params.getParam(
                'isas', ParamType.DocumentReference, false, ['sellers']),
            mk: params.getParam<DocumentReference>(
                'mk', ParamType.DocumentReference, true, ['sellers']),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'open_seller',
          path: '/openSeller',
          builder: (context, params) => OpenSellerWidget(),
        ),
        FFRoute(
          name: 'seller_homepage',
          path: '/sellerHomepage',
          builder: (context, params) => SellerHomepageWidget(
            itemsOrdered: params.getParam<DocumentReference>('itemsOrdered',
                ParamType.DocumentReference, true, ['products']),
          ),
        ),
        FFRoute(
          name: 'seller_product',
          path: '/sellerProduct',
          builder: (context, params) => SellerProductWidget(),
        ),
        FFRoute(
          name: 'seller_profile',
          path: '/sellerProfile',
